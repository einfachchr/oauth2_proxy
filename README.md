...
[![Build Status](https://secure.travis-ci.org/einfachchr/oauth2_proxy.svg?branch=master)](http://travis-ci.org/einfachchr/oauth2_proxy)
...
1. Download [Prebuilt Binary](https://github.com/einfachchr/oauth2_proxy/releases) (current release is `v2.2`) or build with `$ go get github.com/einfachchr/oauth2_proxy` which will put the binary in `$GOROOT/bin`
